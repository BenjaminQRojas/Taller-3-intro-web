...
const Dashboard = () => {
  ...
  const handleApplyFilters = (filters: {
    ...
    setCommitDateRange(filters.dateRange);
    setCommitCategory(filters.category);
    setCommitSearchTerm(filters.searchTerm);
    setCommitDate(filters.date);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
      ...
      {/* Filtros */}
      <DashboardFilters categoriesList={categoriesList} onApplyFilters={handleApplyFilters} />
